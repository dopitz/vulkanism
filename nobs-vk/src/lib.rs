...
//! 
//! This crate is auto generated by python scripts and the [vk.xml](https://github.com/KhronosGroup/Vulkan-Docs). The crate provides types, constants and functions for [vulkan](https://www.khronos.org/vulkan/).
//! 
...
//! Instance and device creation are a large portion of the boiler plate code that comes with implementing a vulkan application, so it makes sense to have a convenient way of doing this in the library (which is why you could argue that it barely does not contradict the "no bullshit" paradigm)
//! 
//! The crate provides builder patterns instance creation, physical device enumeration and selection, and logical device creation.
//! ```rust
//! #[macro_use]
...
//!     .unwrap();
//! 
//!   // Enumerate and list all physical devices
...
//!   }
//! 
//!   // Select a physical device and create a logical device from it
